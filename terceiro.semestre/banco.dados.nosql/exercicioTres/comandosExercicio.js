...
db.funcionario.find(
  { 
    hobbies: { $all: ["FUTEBOL", "TÊNIS DE MESA"] }
  },
  {
    salario: 0,
    admissao: 0,
...
/* 7. Quais os funcionários têm 4 hobbies, sendo que pelo menos 1 hobby seja
natação? Mostrar o nome e os hobbies. */
