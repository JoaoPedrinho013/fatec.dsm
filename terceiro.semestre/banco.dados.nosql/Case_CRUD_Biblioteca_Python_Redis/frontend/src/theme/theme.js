...
const theme = createTheme({
  palette: {
    mode: "light",
    primary: {
      main: "#0071e3",       // azul Apple
      light: "#2997ff",
      dark: "#0051a2",
      contrastText: "#ffffff",
    },
    secondary: {
      main: "#1d1d1f",       // quase preto — Apple/Samsung
      light: "#3d3d3f",
      dark: "#000000",
      contrastText: "#ffffff",
    },
    background: {
      default: "#fbfbfd",    // branco levemente acinzentado da Apple
      paper: "#ffffff",
    },
    text: {
      primary: "#1d1d1f",
    ...
    MuiButton: {
      styleOverrides: {
        ...
        containedSecondary: {
          ...
          "&:hover": { background: "linear-gradient(135deg, #000 0%, #1d1d1f 100%)" },
        },
        outlined: {
          borderWidth: 1.5,
