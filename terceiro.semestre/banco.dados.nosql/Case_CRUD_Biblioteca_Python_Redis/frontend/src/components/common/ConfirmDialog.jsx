...
/**
 * ConfirmDialog estilizado com ícone, cor dinâmica e suporte a loading.
 *
 * Props:
 *  open, onClose, onConfirm
 *  title, message
 *  confirmLabel  (default: "Confirmar")
 *  confirmColor  (default: "primary") — "primary" | "error" | "warning" | "success"
 *  icon          — ReactNode exibido no topo
 *  loading       — boolean
 */
