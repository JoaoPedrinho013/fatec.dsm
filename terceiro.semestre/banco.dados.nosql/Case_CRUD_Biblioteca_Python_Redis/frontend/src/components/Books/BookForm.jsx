...
export default function BookForm({ open, onClose, onSave, livro = null }) {
  ...
  // Src da imagem de preview: arquivo novo > capa existente no servidor
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
              ...
              >
                <img
                  key={imgSrc} // remonta quando o src muda (limpa o erro de carregamento anterior)
                  src={imgSrc}
                  alt="Capa"
                  onError={(e) => {
          ...
          {/* Categorias — Autocomplete filtráve, "Outros" por último */}
          <Grid item xs={12}>
            <Autocomplete
              multiple
              options={CATEGORIAS}
