            ...
            >
              ...
              <ListItemText
                ...
                primaryTypographyProps={{
                  ...
                  color: location.pathname === "/perfil" ? "primary.main" : "text.primary",
                }}
              />
            </ListItemButton>
          </ListItem>
      ...
      <AppBar position="fixed" elevation={0} sx={{ zIndex: (theme) => theme.zIndex.drawer + 1 }}>
        <Toolbar sx={{ maxWidth: 1200, width: "100%", mx: "auto", px: { xs: 1.5, md: 4 } }}>
          ...
          >
            ...
            <Typography
              variant="h6"
              sx={{ fontWeight: 700, color: "text.primary", letterSpacing: "-0.02em", fontSize: { xs: "1rem", md: "1.25rem" } }}
            >
              Biblioteca<span style={{ color: "#0071e3" }}>Digital</span>
            </Typography>
          </Box>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, ml: { xs: 0, md: 2 } }}>
            {isLogged ? (
              <>
                {/* Notificações — apenas para usuários comuns, desktop */}
                {!isAdmin && (
                  <IconButton
                ...
                <Menu
                  ...
                  PaperProps={{
                    sx: { mt: 1, minWidth: 200, borderRadius: 3, border: "1px solid rgba(0,0,0,0.08)" },
                  }}
